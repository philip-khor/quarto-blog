...
This is the treatment you would use if you believed that substitution across pillars is possible but increasingly costly — and that zero on any pillar is catastrophic regardless of excellence elsewhere.

Strict complements would be harsher still: $U = \min(S_1, S_2)$, where the score is determined entirely by the weakest pillar and additional investment in any stronger pillar is wasted. The geometric mean sits between the two extremes.
...
![](images/esg_three_panel.svg){.lightbox}

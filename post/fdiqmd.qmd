...
Malaysia’s implicit model is a bidding war: keep costs low, keep approvals fast, keep tthe prohe welcome mat out, and capital will come. Bank Negara’s anxiety about “not missing the train” on data centres is the macroeconomic version of the same instinct — we have no agency here, the train is leaving, get on. Ninety-nine times out of a hundred, when that is your opening position, something has gone wrong.
...
Chinese manufacturers used Malaysia as an export platform. Panels assembled here were destined for Western buyers at premium prices. Malaysian firms installing solar locally imported directly from mainland China — cheaper, faster, no waiting for expensive leftovers that didn’t make it to the US. The locally manufactured panels and the local solar industry operated in parallel with almost no connection between them.
...
Data centres are, economically, international energy arbitrage infrastructure[^3]. They consume electricity, generate heat, and route data. The value added accrues to the infrastructure owner and the hyperscaler renting rack space. The externalities accrue to whoever lives nearby.
...
People-pleasing is something to address at the therapy office[^4]. Not Putrajaya. Not KOMTAR.

[^4]: Tax-exempt for Malaysian ratepayers

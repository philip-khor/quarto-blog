...
Data centres are, economically, international energy arbitrage infrastructure[^4]. They consume electricity, generate heat, and route data. The value added accrues to the infrastructure owner and the hyperscaler renting rack space. The externalities accrue to whoever lives nearby. The jobs created are HVAC technicians at best, crowding out computer repair crew at worse.
...
People-pleasing is something to address at the therapy office[^5]. Not Putrajaya. Not KOMTAR.

[^5]: Tax-exempt for Malaysian ratepayers
